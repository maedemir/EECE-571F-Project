#!/bin/bash
#SBATCH --job-name extract_cell_NCM
...
for i in {001..050}; do
    python "/projects/ovcare/classification/Maedeh/EECE571F-project/EECE-571F-Project/code/extract_cells.py" \
        --image_dir "/projects/ovcare/classification/Ali/Heram/Dataset/Polyp_dataset/random_patches_10_20_40/Mix/NCM/Normal colonic mucosa-$i/1000/20/" \
        --json_dir "/projects/ovcare/classification/Maedeh/EECE571F-project/EECE-571F-Project/output/NCM/NCM-$i/json" \
        --cell_image_patches_dir "/projects/ovcare/classification/Maedeh/EECE571F-project/EECE-571F-Project/output_extracted_cells/NCM/NCM-$i"
done
