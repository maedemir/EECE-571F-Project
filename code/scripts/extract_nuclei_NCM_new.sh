#!/bin/bash
#SBATCH --job-name test_maedeh_NCM
...
for i in {001..050}; do
    python "/projects/ovcare/classification/Maedeh/EECE571F-project/hover_net/run_infer.py" \
        ...
        --gpu=0 \
        tile \
        --input_dir="/projects/ovcare/classification/Ali/Heram/Dataset/Polyp_dataset/random_patches_10_20_40/Mix/NCM/Normal colonic mucosa-$i/1000/20/" \
        --output="/projects/ovcare/classification/Maedeh/EECE571F-project/EECE-571F-Project/output/NCM/NCM-$i"
done